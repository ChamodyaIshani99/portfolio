...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
   ...
   flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20":""}`}>
    <a href="#top">
    <Image src={isDarkMode ? assets.logo_dark :assets.logo} alt='' className='w-28 cursor-pointer mr-14' priority />
    ...
    <div className='flex items-center gap-4'>
        ...
        items-center gap-3 px-10 py-2.5 border bprder-gray-500 rounded-full ml-4 font-Ovo
