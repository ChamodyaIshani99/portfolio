...
const Header = () => {
  return (
    ...
    items-center justify-center gap-4'>
      ...
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm William Mark <Image src={assets.hand_icon} alt='' 
        className='w-6'/></h3>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            items-center gap-2 bg-white dark:text-black'>My resume<Image src={assets.download_icon} alt='' className='w-4'/></a>
        </div>
    </div>
  )
}
