  ...
  return (
    ...
    gap-20 my-20'>
        ...
        <div className='flex-1'>
            <p className='mb-10 max-w-2xl front-Ovo'> I am an experienced frontend Developer with over a decade of professional expertise in the field. Throughout my
                career, I have had the privilege of collaborating with prestiguous organizations, contributing to their success and growth.
            </p>
            ...
            <ul className='flex item-centger gap-3 sm:gap-5'>
